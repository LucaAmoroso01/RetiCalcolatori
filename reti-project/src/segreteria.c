...
int main(int argc, char **argv) {
     ...
     * il server risponderà ai client sarà la 1026.
     */
    secaddr.sin_family = AF_INET;
    secaddr.sin_addr.s_addr = htonl(INADDR_ANY);
    secaddr.sin_port = htons(1626);
     ...
     */
    if (mysql_real_connect(conn, "10.113.227.215", "root", "luca2001", "universita", 3306, NULL, 0) == NULL) {
